...
public class DungeonGenerator {
	...
	/**
	 * @param seed La graine de génération de donjons, une même graine et des mêmes paramêtres donneront les mêmes donjons
	 */
	 ...
	 * elle génére des salles (-1) selon les arguments donnés et les relient grâce à des couloirs (-2),
	 ...
	 * @see Dungeon
	 */
	public Dungeon generate(int width, int height, int roomsNMin, int roomsNMax, int roomSizeMin, int roomSizeMax, float treasureProp) {
